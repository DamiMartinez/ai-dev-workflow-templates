...
2.  **Task Analysis & Template Matching:**
    *   For any request, first check the `templates/` directory to see if a specific template exists for the requested task (e.g., `templates/002_bug_fix.md`, `templates/003_code_review.md`, `templates/004_git_commit_workflow.md`).
    *   If the request is to fix a bug, you **must** use the `templates/002_bug_fix.md` template as your guide.
...
3.  **New Feature or Development Implementation:**
    *   If the request involves creating a new feature, implementing new code, or any form of new development, you **must** use the `templates/001_task_planning.md` as your guide.
...
5.  **Git Commit Guidelines:**
    *   When preparing to commit changes, you **must** use the `templates/004_git_commit_workflow.md` template as your guide.
